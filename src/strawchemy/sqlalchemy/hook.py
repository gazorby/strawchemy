...
from typing import TYPE_CHECKING, Any, ClassVar, Generic, Literal, Optional, TypeAlias, Union
...
LoadType: TypeAlias = "Union[InstrumentedAttribute[Any], RelationshipLoadSpec]"
