...
class StrawchemyField(StrawberryField):
    ...
    def _list_result_sync(self, repository_call: GraphQLResult[Any, Any]) -> ListResolverResult:
    ...
    def is_list(self) -> bool:
        return True if self.root_aggregations else is_list(self._type_or_annotation())
