...
class SQLAlchemyGraphQLAsyncRepository(SQLAlchemyGraphQLRepository[DeclarativeT, AnyAsyncSession]):
    ...
    async def _insert_nested(self, data: InsertData, level: LevelInput) -> None:
        ...
        """
        new_instance_ids: Sequence[Row[Any]] = await self._insert_many(data)
    ...
    async def _list_by_ids(
        ...
        Fetches records from the strawberry's main model that match the provided
    ...
    async def list(
        ...
        **kwargs: Any,
        ...
        Fetches records from the strawberry's main model, applying optional
